package com.uzm.hylex.rankup.java.util;
...
public final class Reflections {
	...
	public static List<Class<?>> getClasses(String packageName) {
		...
		try {
			...
			JarInputStream jarFile = new JarInputStream(new FileInputStream(Core.getPath()));
			...
			while (true) {
				...
				if (jar.getName().startsWith(packageName) && jar.getName().endsWith(".class")
						&& !jar.getName().contains("$")) {
